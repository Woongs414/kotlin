open class Animal12(val size: Int) {
    fun feed() = println("Feeding...")
}
class Cat12(val jump: Int): Animal12(50)
class Spider(val poison: Boolean): Animal12(1)
// ① 형식 매개변수를 Animal로 제한
class Box12<out T: Animal12>(val element: T) { // 주 생성자에서 val만 허용
...
// ⑤ 공변성- Cat은 Animal의 하위 자료형
    val c2: Box12<Animal12> = Box12<Cat12>(Cat12(10))
